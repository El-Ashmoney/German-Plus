...
@section('page-header', 'All articles')
@section('page-description', 'Show all articles')
    ...
    <div class="col-xs-12">
        <div class="box box-info">
          <div class="box-header">
            <h3 class="box-title">Articles info</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
              ...
              <tr>
                ...
                <td>
                  @if(!empty($article->image))
                    <img src="{{ asset('images/'.$article->image) }}" alt="{{ $article->title }}" class="img-thumbnail sm-img" />
                  @endif
                </td>
                <td>{{ $article->Category->title }}</td>
                <td>
                <a href="{{ route('article.edit', $article->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a>
