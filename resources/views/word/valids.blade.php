...
@section('title', 'Valid words')
@section('page-header', 'Valid words')
@section('page-description', 'Show Valid words')
...
<ol class="breadcrumb">
    ...
    <li class="active">Valid words</li>
</ol>
          ...
          <div class="box-body">
            <table id="datatable" class="table table-bordered table-hover">
              ...
              <tr id="word_{{$word->id}}">
                ...
                <td>
                  <button onclick="set_favourite(this, {{$word->id}})" data-val="{{$word->is_favourite}}"  class="ajax_action btn {{ $word->is_favourite?'btn-success':'btn-default' }} btn-sm"><i class="fa fa-star"></i> </button>
                  <button onclick="set_important(this, {{$word->id}})" data-val="{{$word->is_important}}" class="ajax_action btn {{ $word->is_important?'btn-success':'btn-default' }} btn-sm"><i class="fa fa-bookmark"></i> </button>
