...
@section('page-header', 'Update category')
@section('page-description', 'Update category')
            ...
            <form class="form-horizontal" action="{{ route('category.update', $category->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="index" name="index" value="{{ $category->index  }}" />
                        </div>
                    </div>
